...
The Pareto plan explicitly says: _"If you do nothing else, do these two."_ M1 and M2 were the 1% that delivers 51% of the value. I did M2 but **completely skipped M1**. The project STILL has zero tags. `go install github.com/larsartmann/go-hotspot/cmd/go-hotspot@latest` STILL fails. This is inexcusable — it was 5 minutes of work and the highest-leverage action in the entire plan.
